...
from core.models import Talk, Speaker, Course
...
class TalkListGetEmpty(TestCase):
    ...
    def test_get_empty(self):
        self.assertContains(self.resp, 'Ainda não existem palestras pela manhã.')
        self.assertContains(self.resp, 'Ainda não existem palestras a tarde.')
