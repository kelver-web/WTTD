...
class SubscribePostTest(TestCase):
    ...
    def test_subscription_email_to(self):
        email = mail.outbox[0]
        expect = ['contato@eventex.com.br', 'kelverwt@gmail.com']
    ...
    def test_subscription_email_body(self):
        ...
        self.assertIn('Kelver Alves', email.body)
        self.assertIn('12345678901', email.body)
        self.assertIn('kelverwt@gmail.com', email.body)
        self.assertIn('84996068403', email.body)
